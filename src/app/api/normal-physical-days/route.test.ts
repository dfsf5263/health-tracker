...
function makeRequest(method: string, body?: unknown): NextRequest {
  ...
  return new NextRequest('http://localhost/api/normal-physical-days', init)
}

describe('GET /api/normal-physical-days', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  it('returns days for authenticated user', async () => {
    ...
    db.normalPhysicalDay.findMany.mockResolvedValue([
...
describe('POST /api/normal-physical-days', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  it('creates a day', async () => {
    ...
    db.normalPhysicalDay.create.mockResolvedValue({
      id: 'new-id',
  ...
  it('returns 409 for duplicate', async () => {
    ...
    db.normalPhysicalDay.create.mockRejectedValue({ code: 'P2002' })
