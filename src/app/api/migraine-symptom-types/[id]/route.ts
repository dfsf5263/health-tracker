...
export const PUT = withApiLogging(
  async (request: NextRequest, { params }: { params: Promise<{ id: string }> }) => {
    ...
    try {
      ...
      if (!existingType) {
        return ApiError.notFound('Migraine symptom type')
      }
      ...
      return ApiError.internal('update migraine symptom type')
    }
  }
)
...
export async function DELETE(
  ...
  try {
    ...
    return ApiError.internal('delete migraine symptom type')
  }
}
