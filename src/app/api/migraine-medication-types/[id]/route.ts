...
export const PUT = withApiLogging(
  async (request: NextRequest, { params }: { params: Promise<{ id: string }> }) => {
    ...
    try {
      ...
      if (!existingType) {
        return ApiError.notFound('Migraine medication type')
      }
      ...
      return ApiError.internal('update migraine medication type')
    }
  }
)
...
export async function DELETE(
  ...
  try {
    ...
    return ApiError.internal('delete migraine medication type')
  }
}
